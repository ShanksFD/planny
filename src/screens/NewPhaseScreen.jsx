...
import {getProjectDetails, updateProjectPhase} from "../actions/projectActions"
         ...
         <Form onSubmit={submitHandler}>
            <Row>
               <Col>
                  <Form.Group controlId="label" className="my-3">
                     ...
                     <Form.Control required type="text" placeholder="Phase label" value={label} onChange={ e =>
                     {
            ...
            <Row>
               <Form.Group controlId="description" className="my-3">
                  ...
                  <Form.Control required as="textarea" rows={2} placeholder="Phase description" value={desc} onChange={ e =>
                  {
            ...
            <Row>
               <Form.Group controlId="description" className="my-3">
                  ...
                  <Form.Control required as="textarea" rows={2} placeholder="Empolyees" value={employees} onChange={ e =>
                  {
            ...
            <Row>
              <Col lg={6} md={6} sm={12}>
                  <Form.Group controlId="startDate" className="my-3">
                     ...
                     <Form.Control required type="date" min={projectDetails.project.start_date || 0} max={projectDetails.project.end_date || 0} 
